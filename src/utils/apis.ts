...
/** custom start */
export const getRegWeappRequest: IRequestMsg = {
    url: `${HOST}/admin/regist-weapp`,
    method: "get"
}

export const submitRegWeappRequest: IRequestMsg = {
    url: `${HOST}/admin/regist-weapp/create`,
    method: "post"
}

export const getRidSearchRequest: IRequestMsg = {
    url: `${HOST}/admin/openapi/rid`,
    method: "post"
}

export const clearApiQuotaRequest: IRequestMsg = {
    url: `${HOST}/admin/openapi/clear-quota`,
    method: "post"
}

export const searchAuthorizedAccountRequest: IRequestMsg = {
    url: `${HOST}/admin/authorizer-search`,
    method: "get"
}
...
export const getPullAuthorizedAccountRequest: IRequestMsg = {
    url: `${HOST}/admin/pull-authorizer-list`,
    method: "post"
}
