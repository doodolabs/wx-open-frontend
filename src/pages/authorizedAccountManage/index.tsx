import { Table, Input, PopConfirm, Dialog, Tabs, MessagePlugin, Button } from 'tdesign-react';
import { SearchIcon, CloudDownloadIcon } from 'tdesign-icons-react'
...
import {
    ...
    getPullAuthorizedAccountRequest,
...
export default function AuthorizedAccountManage() {
    ...
    const getHistoryAccountList = async () => {
        await request({ request: getPullAuthorizedAccountRequest })
    }
    ...
    return (
        <div>
            ...
            <div className="normal_flex">
                <div className="blue_circle" />
                <p className="desc" style={{ margin: 0 }}>如需拉取部署微管家以前的授权数据，可向微管家服务发起数据同步请求，请点击 <Button shape="circle" size="small" onClick={getHistoryAccountList} icon={<CloudDownloadIcon />} /></p>
            </div>
