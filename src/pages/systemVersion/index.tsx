    ...
    return (
        <div>
            ...
            <div className="normal_flex">
                ...
                <p style={{ marginRight: '20px' }} className="desc">V 2.2.2</p>
            </div>
            <div className="normal_flex">
                <p style={{ width: '100px' }}>更新时间</p>
                <p style={{ marginRight: '20px' }} className="desc">2023-10-12</p>
            </div>
            ...
            <div className="normal_flex">
                <p className="desc">本地部署版本更新日志，</p>
                <a style={{ marginRight: '20px' }} className="a" href="https://blog.11010.net/p/golang-wx-open-wxcloudrun-wxcomponent/" target="_blank">立即前往</a>
            </div>
